...
enum {
    NATIONAL_DEX_NONE,
    // Camborea    
    NATIONAL_DEX_ALLILEAF,
    NATIONAL_DEX_CROCOFROND,
    NATIONAL_DEX_DRACODILE,
    NATIONAL_DEX_LAVASAUR,
    NATIONAL_DEX_BRONTOSEAR,
    NATIONAL_DEX_VOLBRACHIO,
    NATIONAL_DEX_SHARQUA,
    NATIONAL_DEX_THRESHARP,
    NATIONAL_DEX_SLASHARK,
    NATIONAL_DEX_CAPPI,
    NATIONAL_DEX_11,
    NATIONAL_DEX_PEBBIRD,
    NATIONAL_DEX_13,
    NATIONAL_DEX_14,
    NATIONAL_DEX_GRUBBUG,
    NATIONAL_DEX_16,
    NATIONAL_DEX_17,
    NATIONAL_DEX_18,
    NATIONAL_DEX_19,
