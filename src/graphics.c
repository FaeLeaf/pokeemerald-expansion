...
const u32 gSummaryPage_Green_Tilemap[]        = INCBIN_U32("graphics/summary_screen/page_green.bin.lz");
...
const u32 gSummaryPage_Ribbons_Tilemap[]      = INCBIN_U32("graphics/summary_screen/page_ribbons.bin.lz");
